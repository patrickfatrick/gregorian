...
test.beforeEach((t) => {
  t.context.overridesComplete = {
    ...
    monthsShort: [ 'jan', 'fév', 'mars', 'avr', 'mai', 'juin', 'jui', 'août', 'sept', 'oct', 'nov', 'dec' ],
...
test('errors out if invalid date passed in', (t) => {
  t.throws(() => reformWithOverrides(t.context.overridesComplete)('E, N o, Y H:T:S.L')('1988-04-11T00:00:00.000Z'), TypeError)
})

test('uses the current time by default', (t) => {
  const clock = sinon.useFakeTimers(new Date('1985-05-22T00:00:00.000Z'))
  t.is(reformWithOverrides(t.context.overridesComplete)('E, N o, Y H:T:S.L')(), 'mardi, mai 21e, 1985 17:00:00.000')
  clock.restore()
})

test('can be composed', (t) => {
  const reformWithOverridesFn = reformWithOverrides(t.context.overridesComplete)('E, N o, Y H:T:S.L')
  t.is(reformWithOverridesFn(new Date('1988-04-11T12:45:00.000Z')), 'lundi, avril 11e, 1988 05:45:00.000')
})

test('can be run with all arguments at once', (t) => {
  t.is(
    reformWithOverrides(t.context.overridesComplete, 'E, N o, Y H:T:S.L z', new Date('1988-04-11T12:45:00.000Z')),
...
test('can be run with an incomplete override list', (t) => {
  t.is(
    reformWithOverrides(t.context.overridesIncomplete, 'E, N o, Y H:T:S.L z', new Date('1988-04-11T12:45:00.000Z')),
