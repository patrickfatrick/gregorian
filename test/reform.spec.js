...
test('uses the current time by default', (t) => {
  ...
  t.is(reform('E, N o, Y H:T:S.L')(), 'Tuesday, May 21st, 1985 18:00:00.000')
  clock.restore()
})
...
test('converts a date to a string with a specified format', (t) => {
  ...
  t.is(reform('E, N Y-m-d G:T:S.L z')(new Date('10/25/2015 01:00:00')), 'Sunday, October 2015-10-25 01:00:00.000 UTC-06:00')
})

test('converts a date using local time', (t) => {
  t.is(reform('E, N o, Y H:T:S.L')(new Date('1988-04-11T12:45:00.000Z')), 'Monday, April 11th, 1988 06:45:00.000')
})
...
test('can be composed', (t) => {
  ...
  t.is(reformFn(new Date('1988-04-11T12:45:00.000Z')), 'Monday, April 11th, 1988 06:45:00.000')
})
